...
# 플레이스 저장은 '플레이스 방문'에 통합되어 화면에서 감춰졌으므로 방문 쪽에 합산해 둔다.
DEFAULT_PLANS = [
    ("basic",    "베이직",   5.5,  5, 100,  5, 100, 20,  600, 0, 0,  2,  50),
    ("standard", "스탠다드", 5.0, 10, 200, 10, 200, 40, 1200, 0, 0,  5, 100),
    ("premium",  "프리미엄", 4.5, 20, 400, 20, 400, 80, 2400, 0, 0, 10, 200),
]
